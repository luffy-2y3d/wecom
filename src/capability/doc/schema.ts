            ...
            oneOf: [
              {
                ...
                properties: { replace_text: replaceTextRequest },
              },
              {
                required: ["insert_text"],
                properties: { insert_text: insertTextRequest },
              },
              {
              ...
              },
              {
                ...
                properties: { insert_image: insertImageRequest },
              },
              {
              ...
              },
              {
                ...
                properties: { insert_table: insertTableRequest },
              },
              {
    ...
    },
    {
      ...
      properties: {
        ...
        formInfo: {
          ...
          description:
            "收集表 form_info 对象，至少应包含 form_title 等官方字段",
        },
        spaceId: {
          type: "string",
          minLength: 1,
    ...
    },
    {
      ...
      properties: {
        ...
        requests: {
          ...
          minItems: 1,
          description:
            "统计请求列表；每项按企业微信 get_form_statistic 官方结构填写",
          items: nonEmptyObjectProperty,
        },
      },
    },
                            ...
                            text_format: {
                              ...
                              properties: {
                                font: {
                                  type: "string",
                                  description:
                                    "字体名称（Microsoft YaHei, SimSun, Arial 等）",
                                },
                                font_size: {
                                  type: "integer",
                                  minimum: 1,
    ...
    },
    {
      ...
      properties: {
        ...
        type: {
          type: "integer",
          enum: [1, 2],
          description: "规则类型：1-全员权限，2-额外权限",
        },
        rule_id_list: {
          type: "array",
          items: { type: "integer" },
